  ...
  return (
    <section className="description">
      <div className="description__content">
        <h3 className="description__subtitle">WOMEN COLLECTION</h3>
        <hr className="pink_line" />
        ...
        <p className="description__price">$561</p>
          ...
          <details className="description__filters__item">
            ...
            <div className="description__filters__item-show">
              <form action="#">
                ...
                <label>
                  <input type="checkbox" name="size2" id="size2" />s
                </label>
                <label>
                  <input type="checkbox" name="size3" id="size3" />m
                </label>
                <label>
                  <input type="checkbox" name="size4" id="size4" />l
                </label>
              </form>
            </div>
          </details>
        ...
        <a href="#" className="add_to_cart_button">
          <svg
            width="27"
            height="25"
            viewBox="0 0 27 25"
